...
void RadioChannel::StartTx(shared_ptr<PacketBurst> p, TransmittedSignal *txSignal, NetworkNode *src)
{
...
void RadioChannel::StartRx(shared_ptr<PacketBurst> p, TransmittedSignal *txSignal, NetworkNode *src)
{
  DEBUG_LOG_START_1(SIM_ENV_TEST_DEVICE_ON_CHANNEL)
...
void RadioChannel::AddDevice(NetworkNode *d)
{
  DEBUG_LOG_START_1(SIM_ENV_TEST_DEVICE_ON_CHANNEL)
...
void RadioChannel::DelDevice(NetworkNode *d)
{
  DEBUG_LOG_START_1(SIM_ENV_TEST_DEVICE_ON_CHANNEL)
...
bool RadioChannel::IsAttached(NetworkNode *d)
{
  for (auto node : *GetDevices())
  {
    if (node->GetIDNetworkNode() == d->GetIDNetworkNode())
...
void RadioChannel::SetPropagationLossModel(PropagationLossModel *m)
{
...
int RadioChannel::GetChannelId(void)
{
  return m_channelId;
}
